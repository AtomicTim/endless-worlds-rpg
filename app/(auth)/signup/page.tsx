...
╚══════════════════════════════╝`}
          ...
          <h1 className="text-lg tracking-widest text-amber-500/90">
            CREATE ACCOUNT
          </h1>
          <p className="text-xs text-muted-foreground">
            Your profile will be forged when you enter the realm.
          </p>
        </header>

        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            <Label htmlFor="displayName" className="text-amber-600/90">
              Display name
            </Label>
            <Input
              id="displayName"
          ...
          <div className="space-y-2">
            <Label htmlFor="confirmPassword" className="text-amber-600/90">
              Confirm password
            </Label>
            <Input
              id="confirmPassword"
