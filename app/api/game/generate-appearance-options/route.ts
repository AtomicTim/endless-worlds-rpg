...
function buildPrompt(
  ...
  return [
    ...
    "",
    "- summary must NEVER include the character's name. Write it as an",
    "  objective physical description that works for any name:",
    ...
    "  name independently of the appearance they pick.",
    "",
